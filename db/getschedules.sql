SELECT u.user_id,u.full_name,u.email,u.phone_number,u.address,u.emergency_contact,u.image, s.publish,s.monday_morning,s.monday_night,s.tuesday_morning,s.tuesday_night,s.wednesday_morning,s.wednesday_night,
