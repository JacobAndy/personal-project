  ...
  render() {
    ...
    if (!this.props.companys.length) {
      ...
      employeeInfoAndSchedules = _(
        this.props.adminSchedules.filter(e => {
                          ...
                          <Dialog
                            ...
                            actions={[
                              <FlatButton
                                ...
                                primary={true}
                                onClick={() =>
                                  handleOpen("wednesdaymorningopen")
                                }
                              />,
                              <FlatButton
                                label="Clear"
                          ...
                          <Dialog
                            ...
                            actions={[
                              <FlatButton
                                ...
                                primary={true}
                                onClick={() =>
                                  handleOpen("thursdaymorningopen")
                                }
                              />,
                              <FlatButton
                                label="Clear"
                          ...
                          <Dialog
                            ...
                            actions={[
                              <FlatButton
                                ...
                                primary={true}
                                onClick={() =>
                                  handleOpen("saturdaymorningopen")
                                }
                              />,
                              <FlatButton
                                label="Clear"
